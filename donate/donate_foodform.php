...
<section class="donate py-5 ">
    <div class="container">
            ...
            <div class="col-md-4 left" >
                ...
                <div class="sidebar">
                  ...
                  <span class="title">Money</span>  
                    ...
                    <li class="active"><a href="donate_foodform.php">
        ...
        <div class="col-md-8"><h1 class="text-center py-3 mt-2">Donate Food</h1>
        <p>Enter Pin Code to search </p>

        <form action="donate-food.php" method="POST" autofocus="on" autocomplete="off">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group" id="type">
             <label class="label" for="radio">Type Of Food </label> <br>
             <input type="radio" id="raw" name="type" value="Raw" required>
  <label for="raw">Raw Food</label>
  <input type="radio" id="cooked" name="type" value="Cooked">
  <label for="cooked">Cooked Food</label><br>
<span id="typeSpan"> 
                        </span>
             </div>
            </div>
            ...
            <div class="col-md-6">
            <div class="form-group" id="aprxWt">
              <label class="label hide" for="aprxWt">Approx Weight</label>
            <select class="form-control multiple-select " id="aprxWt" name="aprxWt" aria-label=".form-select-lg example" required>
            <option selected value="">Select approximate value </option>
            <option value="1-10">1KG-10KG</option>
               ...
               <option value="More than 50">More Than 50KG</option>
    </select> 
              <span id="wtSpan"> 
      </span>
            </div>
